...
# SPAWN RANDOM ENEMY #
######################
scoreboard players random @s wave_spawner_r 0 3
...
execute as @s[scores={wave_spawner_r=2}] at @s run summon fs:enemy_foot_soldier_indigo ~ ~ ~ ~ ~ fs:set_movement_state_appear
execute as @s[scores={wave_spawner_r=3}] at @s run summon fs:enemy_foot_soldier_orange ~ ~ ~ ~ ~ fs:set_movement_state_appear
...
#execute as @s[scores={wave_spawner_r=13}] at @s run summon fs:enemy_mouser ~ ~ ~ ~ ~ fs:set_movement_state_appear
