scoreboard players set @e[type=fs:game,scores={code_input_idx=0}] code_input_0 1
scoreboard players set @e[type=fs:game,scores={code_input_idx=1}] code_input_1 1
scoreboard players set @e[type=fs:game,scores={code_input_idx=2}] code_input_2 1
scoreboard players set @e[type=fs:game,scores={code_input_idx=3}] code_input_3 1
