...
execute as @e[type=fs:game] run tellraw @a {"rawtext":[{"text":""},{"text":"<"},{"text":""},{"text":" "},{"translate":"entity.fs:npc_splinter.name"},{"text":"§f> "},{"text":""},{"translate":"chat.training_start_15.phrase_0"}]}
