...
scoreboard players remove @s[scores={is_blocking=0,in_cutscene=0,is_downed=0}] health 1
execute as @e[family=enemy,c=1,scores={s_perf_mode=0}] at @s run summon fs:player_launcher ~ ~ ~ 0 0 fs:player_knockback
