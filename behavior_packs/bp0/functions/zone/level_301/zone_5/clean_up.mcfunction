...
# CLEAN UP #
############
scoreboard players add @e[scores={level=301,zone=5}] retain 0
scoreboard players set @e[scores={level=301,zone=5},tag=has_rider] retain 1
scoreboard players set @e[scores={level=301,zone=5},tag=retain] retain 1
event entity @e[scores={level=301,zone=5,retain=0}] fs:instant_despawn
event entity @e[scores={level=!301}] fs:instant_despawn
