...
# CLEAN UP #
############
scoreboard players add @e[scores={level=101,zone=3}] retain 0
scoreboard players set @e[scores={level=101,zone=3},tag=has_rider] retain 1
scoreboard players set @e[scores={level=101,zone=3},tag=retain] retain 1
event entity @e[scores={level=101,zone=3,retain=0}] fs:instant_despawn
