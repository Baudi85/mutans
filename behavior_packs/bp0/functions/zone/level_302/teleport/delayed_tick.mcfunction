...
# TELEPORT PLAYERS:
execute as @s[scores={level_delay_tick=40}] run tp @a[scores={is_camera=0}] 2064.5 29 277.5 -180 0
execute as @s[scores={level_delay_tick=50}] run function player/spread_around_host
execute as @s[scores={level_delay_tick=40}] run tp @e[family=player_companion] 2064.5 29 277.5 -180 0
execute as @s[scores={level_delay_tick=50}] run function player_companion/spread_around_host
execute as @s[scores={level_delay_tick=140}] run function zone/level_302/set_active
# HIDE FADER:
