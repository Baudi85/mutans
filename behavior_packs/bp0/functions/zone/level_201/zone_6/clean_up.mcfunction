...
# CLEAN UP #
############
scoreboard players add @e[scores={level=201,zone=6}] retain 0
scoreboard players set @e[scores={level=201,zone=6},tag=has_rider] retain 1
scoreboard players set @e[scores={level=201,zone=6},tag=retain] retain 1
event entity @e[scores={level=201,zone=6,retain=0}] fs:instant_despawn
