...
# CLEAN UP #
############
scoreboard players add @e[scores={level=701,zone=15}] retain 0
scoreboard players set @e[scores={level=701,zone=15},tag=has_rider] retain 1
scoreboard players set @e[scores={level=701,zone=15},tag=retain] retain 1
event entity @e[scores={level=701,zone=15,retain=0}] fs:instant_despawn
