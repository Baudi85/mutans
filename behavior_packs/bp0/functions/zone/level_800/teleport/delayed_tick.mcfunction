...
# TELEPORT PLAYERS:
execute as @s[scores={level_delay_tick=40}] run tp @a[scores={is_camera=0}] -629.5 -59 1319.5 90 0
execute as @s[scores={level_delay_tick=50}] run function player/spread_around_host
execute as @s[scores={level_delay_tick=40}] run tp @e[family=player_companion] -629.5 -59 1319.5 90 0
execute as @s[scores={level_delay_tick=50}] run function player_companion/spread_around_host
execute as @s[scores={level_delay_tick=140}] run function zone/level_800/set_active
# HIDE FADER:
...
# FADER HIDDEN EVENT:
execute as @s[scores={level_delay_tick=200}] run function world/event/obj_id_1760
# RESET TICK:
