...
##
execute as @e[type=fs:zone,name=zone_0,tag=destruct] run function zone/level_50/zone_0/destructor
##
execute as @e[type=fs:zone,name=zone_0,tag=!destruct] run scoreboard players set @e[type=fs:game] zone_staged_0 2
##
# Level 50, Zone 0:
execute as @e[type=fs:zone,name=zone_0,scores={zone_is_staged=0},tag=!destruct] at @s run function zone/level_50/zone_0/constructor
##
###########
# Zone: 0 #
###########
...
# TICK WAYPOINTS #
##################
function zone/level_50/waypoints/tick