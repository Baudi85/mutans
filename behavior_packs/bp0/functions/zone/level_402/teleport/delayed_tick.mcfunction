...
# TELEPORT PLAYERS:
execute as @s[scores={level_delay_tick=40}] run tp @a[scores={is_camera=0}] 2937.5 13 361.5 90 0
execute as @s[scores={level_delay_tick=50}] run function player/spread_around_host
execute as @s[scores={level_delay_tick=40}] run tp @e[family=player_companion] 2937.5 13 361.5 90 0
execute as @s[scores={level_delay_tick=50}] run function player_companion/spread_around_host
execute as @s[scores={level_delay_tick=140}] run function zone/level_402/set_active
# HIDE FADER:
execute as @s[scores={level_delay_tick=100}] run function prototype/platformer/init
execute as @s[scores={level_delay_tick=120}] run execute as @a[scores={is_camera=0}] run function ui/arcade_cab/show/tempestra_nuucuu_ffb
execute as @s[scores={level_delay_tick=160}] run function prototype/platformer/start
# REMOVE TAGS:
