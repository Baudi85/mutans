...
execute as @s[scores={zone_delay_tick=20}] run tp @a[scores={is_camera=0}] 4499.5 -19 303.5 90 0
execute as @s[scores={level_delay_tick=30}] run function player/spread_around_host
execute as @s[scores={zone_delay_tick=20}] run tp @e[family=player_companion] 4499.5 -19 303.5 90 0
