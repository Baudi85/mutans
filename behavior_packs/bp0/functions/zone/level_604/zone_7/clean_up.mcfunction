...
# CLEAN UP #
############
scoreboard players add @e[scores={level=604,zone=7}] retain 0
scoreboard players set @e[scores={level=604,zone=7},tag=has_rider] retain 1
scoreboard players set @e[scores={level=604,zone=7},tag=retain] retain 1
event entity @e[scores={level=604,zone=7,retain=0}] fs:instant_despawn
