...
execute as @s[scores={zone_delay_tick=20}] run tp @a[scores={is_camera=0}] 4583.5 -20 446.5 -180 0
execute as @s[scores={level_delay_tick=30}] run function player/spread_around_host
execute as @s[scores={zone_delay_tick=20}] run tp @e[family=player_companion] 4583.5 -20 446.5 -180 0
