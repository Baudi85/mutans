...
# CLEAN UP #
############
scoreboard players add @e[scores={level=601,zone=4}] retain 0
scoreboard players set @e[scores={level=601,zone=4},tag=has_rider] retain 1
scoreboard players set @e[scores={level=601,zone=4},tag=retain] retain 1
event entity @e[scores={level=601,zone=4,retain=0}] fs:instant_despawn
