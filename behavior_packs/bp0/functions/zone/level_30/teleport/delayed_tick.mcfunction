...
# TELEPORT PLAYERS:
execute as @s[scores={level_delay_tick=40}] run tp @a[scores={is_camera=0}] -1775.5 1 271.5 -180 0
execute as @s[scores={level_delay_tick=50}] run function player/spread_around_host
execute as @s[scores={level_delay_tick=40}] run tp @e[family=player_companion] -1775.5 1 271.5 -180 0
execute as @s[scores={level_delay_tick=50}] run function player_companion/spread_around_host
execute as @s[scores={level_delay_tick=140}] run function zone/level_30/set_active
# HIDE FADER:
...
# FADER HIDDEN EVENT:
execute as @s[scores={level_delay_tick=200}] run function world/event/oobe_start
# RESET TICK:
