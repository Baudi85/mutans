...
# ██░░░░░░░░░░░░░░░░██
# ████████████████████
#say Level 30 (Level 0: OOBE), Zone 0 - Constructor

############
# CLEAN UP #
############
execute as @s[scores={zone_tick_0=0}] run function zone/level_30/zone_0/despawn_enemies
####################
# SCORE MANAGEMENT #
####################
scoreboard players set @s[scores={zone_tick_0=0}] level 30
###################
# TAG ZONE ENTITY #
###################
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:npc_michelangelo,tag=idxmep2vzxuieil9] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:npc_raphael,tag=idxdpijtc6xtsotx] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:prop_bedroom_mikey,tag=idxnjolxs8nrbmle] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:prop_bedroom_raph,tag=idxnl3jda04s19b] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:npc_donatello,tag=idxcvvxizoqi5wvr] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:npc_leonardo,tag=idxculwwmedr5rli] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:prop_bedroom_don,tag=idx58kcnw0cuwwvn] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=1}] at @s run scoreboard players set @e[type=fs:prop_bedroom_leo,tag=idxmhsb0c4pfqxgs] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=2}] at @s run scoreboard players set @e[type=fs:prop_shoji_screen,tag=idx7drgusa6tnp0v] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=3}] at @s run scoreboard players set @e[type=fs:prop_shoji_screen,tag=idxogedi6vj37egq] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=4}] at @s run scoreboard players set @e[type=fs:prop_japanese_sign,tag=idxzowgqfzlwxfj6] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=5}] at @s run scoreboard players set @e[type=fs:prop_don_lab_machine,tag=idxrtyyki0y3o9h] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=6}] at @s run scoreboard players set @e[type=fs:prop_don_lab_desk,tag=idx8bl8zfhc3v0o] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=7}] at @s run scoreboard players set @e[type=fs:prop_turtle_rug,tag=idxd3wpjb359ru] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=8}] at @s run scoreboard players set @e[type=fs:vehicle_van,tag=idxc6j1v2t4nzjv] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=9}] at @s run scoreboard players set @e[type=fs:prop_japanese_sign,tag=idxwpkvxhohaa1tk] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=10}] at @s run scoreboard players set @e[type=fs:prop_sofa,tag=idxhvjonhnsmh1y] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=11}] at @s run scoreboard players set @e[type=fs:prop_don_lab_workbench,tag=idx3p4dnz2ztamzl] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=12}] at @s run scoreboard players set @e[type=fs:prop_don_lab_ceiling_laser,tag=idxlg6lugy2pyox] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=13}] at @s run scoreboard players set @e[type=fs:prop_don_lab_machine,tag=idxojjcj2bstsoir] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=14}] at @s run scoreboard players set @e[type=fs:prop_japanese_sign,tag=idxohrq5uco1yqg] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=15}] at @s run scoreboard players set @e[type=fs:prop_kitchen_table,tag=idxutelyvkjqt0r] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=16}] at @s run scoreboard players set @e[type=fs:prop_foot_soldier_dummy,tag=idx4ku97ojup9yi] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=17}] at @s run scoreboard players set @e[type=fs:npc_splinter,tag=idxtjes3lequgce] level 30
...
# SCORES:
execute as @s[scores={zone_tick_0=18}] at @s run scoreboard players set @e[type=fs:prop_foot_soldier_dummy,tag=idx6wmottlo3orhb] level 30
