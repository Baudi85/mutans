...
execute as @s[scores={ai_tick=70..90,s_perf_mode=0..1}] at @s run particle fs:boss_tempestra_travel ~ ~ ~

execute as @s[scores={ai_tick=60}] at @s run tp @s @e[type=fs:ai_marker,scores={active=1}]
execute as @s[scores={ai_tick=60,s_perf_mode=0..1}] at @s run particle fs:enemy_appear ~ ~ ~

execute as @s[scores={ai_tick=55}] at @s run tp @s @e[type=fs:ai_marker,scores={active=1}]
execute as @s[scores={ai_tick=55,s_perf_mode=0..1}] at @s run particle fs:boss_tempestra_travel ~ ~ ~
