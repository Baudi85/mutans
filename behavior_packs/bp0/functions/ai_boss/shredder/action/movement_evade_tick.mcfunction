...
execute as @s[scores={ai_tick=100,s_perf_mode=0}] at @s run particle fs:smoke ~ ~ ~
execute as @s[scores={ai_tick=100,s_perf_mode=0}] at @s run particle fs:enemy_land ~ ~ ~
...
execute as @s[scores={ai_tick=80..90}] at @s run particle fs:smoke ~ ~ ~


execute as @s[scores={ai_tick=60}] at @s run tp @s @e[type=fs:ai_marker,scores={active=1}]
execute as @s[scores={ai_tick=60,s_perf_mode=0}] at @s run particle fs:enemy_land ~ ~ ~
