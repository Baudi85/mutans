...
execute as @s[scores={ai_tick=40}] at @s run summon fs:boss_launcher ^ ^ ^-1 0 0 fs:boss_krang_dash
execute as @s[scores={ai_tick=30}] at @s run summon fs:boss_launcher ^ ^ ^-1 0 0 fs:boss_krang_dash
execute as @s[scores={ai_tick=20}] at @s run summon fs:boss_launcher ^ ^ ^-1 0 0 fs:boss_krang_dash
execute as @s[scores={ai_tick=10}] at @s run summon fs:boss_launcher ^ ^ ^-1 0 0 fs:boss_krang_dash